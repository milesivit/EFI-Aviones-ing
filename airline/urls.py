...
urlpatterns = [
    ...
    path(
        route="my-reservations/", view=reservation_by_user, name="reservation_by_user"
    ),
    ...
    path(route="flightstatus/", view=add_status_flight, name="add_status_flight"),
    ...
    path(route="help/", view=help_view, name="help_view"),
    # Editar un usuario existente (por ID)
    path(route="users/edit/<int:user_id>/", view=edit_user, name="edit_user"),
    ...
    path(route="users/", view=user_list, name="user_list"),
    # Registrar un nuevo usuario
    path(route="users/register/", view=user_register, name="user_register"),
    # Login de usuarios
    path(route="users/login/", view=user_login, name="user_login"),
    # Listar todos los aviones
    path(route="planes/", view=plane_list, name="plane_list"),
    # Detalle de un avión específico (por ID)
    path(route="planes/details/<int:plane_id>", view=plane_detail, name="plane_detail"),
