...
SECRET_KEY = "django-insecure-pq1*o$79snn0ypi8f$oz!d_tku-!d-(&*6g*0q*z+c$i0)w0@h"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
# se deja provisorio al estar en desarrollo
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        "API REST para la gestión de vuelos, pasajeros, reservas y tickets de la aerolínea Virgin Atlantic. "
